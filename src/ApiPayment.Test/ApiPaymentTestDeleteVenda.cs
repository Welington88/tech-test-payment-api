...
public class ApiPaymentTestDeleteVenda : IClassFixture<DbFixture>
{
    ...
    public ApiPaymentTestDeleteVenda(DbFixture fixture)
    {
        fixture.Init();
        ...
        var retorno = deleteVendaRetorno();

        _vendaResositoryMock = new Mock<IVendaRepository>();
        _vendaResositoryMock.Setup(m => m.DeleteVenda(It.IsAny<int>())).Returns(retorno);
    ...
    //Act
    public async Task<bool> deleteVendaRetorno(){

        return await Task.FromResult(true);
    }

    [Theory(DisplayName = "DeleteVenda")]
    [InlineData(1)]
    public void DeleteVenda(int numeroPedido)
    {
        //Arrange
        ...
        var result = _vendaService.DeleteVenda(numeroPedido);
