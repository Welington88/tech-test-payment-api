...
public class ApiPaymentTestPostVenda : IClassFixture<DbFixture>
{
    ...
    public ApiPaymentTestPostVenda(DbFixture fixture)
    {
        fixture.Init();
    ...
    public void CriarVenda()
    {
        ...
        var result = _vendaService.PostVenda(vendaDTO);
