...
public class ApiPaymentTestPostVendaErro : IClassFixture<DbFixture>
{
    ...
    public ApiPaymentTestPostVendaErro(DbFixture fixture)
    {
        fixture.Init();
        ...
        var retorno = CriarVendaRetorno();

        _vendaResositoryMock = new Mock<IVendaRepository>();
        _vendaResositoryMock.Setup(m => m.PostVenda(It.IsAny<VendaDTO>())).Returns(retorno);
    ...
    //Act
    public async Task<bool> CriarVendaRetorno(){

        return await Task.FromResult(true);
    }

    [Fact(DisplayName = "CriarVenda")]
    public void CriarVenda()
    {
        ...
        var result = _vendaService.PostVenda(null);
