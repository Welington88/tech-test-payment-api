...
public class ApiPaymentTestPutVendaErro : IClassFixture<DbFixture>
{
    ...
    public ApiPaymentTestPutVendaErro(DbFixture fixture)
    {
        fixture.Init();
    ...
    public void AlterarVenda(int numeroPedido)
    {
        ...
        var result = _vendaService.PutVenda(numeroPedido,null,vendaDTO.Status);
