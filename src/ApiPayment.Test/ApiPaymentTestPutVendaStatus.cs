...
public class ApiPaymentTestPutVendaStatus : IClassFixture<DbFixture>
{
    ...
    public ApiPaymentTestPutVendaStatus(DbFixture fixture)
    {
        fixture.Init();
    ...
    [InlineData(1, Status.AguardandoPagamento, Status.Cancelada)]
    [InlineData(1, Status.AguardandoPagamento, Status.PagamentoAprovado)]
    [InlineData(1, Status.PagamentoAprovado, Status.EnviadoParaTransportadora)]
    [InlineData(1, Status.PagamentoAprovado, Status.Cancelada)]
    [InlineData(1, Status.EnviadoParaTransportadora, Status.Entregue)]
