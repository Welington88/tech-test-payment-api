...
public class ApiPaymentTestPutVendaStatusErro : IClassFixture<DbFixture>
{
    ...
    public ApiPaymentTestPutVendaStatusErro(DbFixture fixture)
    {
        fixture.Init();
    ...
    [InlineData(1, Status.AguardandoPagamento, Status.Entregue)]
    [InlineData(1, Status.AguardandoPagamento, Status.EnviadoParaTransportadora)]
    [InlineData(1, Status.PagamentoAprovado, Status.AguardandoPagamento)]
    [InlineData(1, Status.PagamentoAprovado, Status.Entregue)]
    [InlineData(1, Status.EnviadoParaTransportadora, Status.AguardandoPagamento)]
    [InlineData(1, Status.EnviadoParaTransportadora, Status.PagamentoAprovado)]
    [InlineData(1, Status.Entregue, Status.PagamentoAprovado)]
    public void AlterarVenda(int numeroPedido, Status lastStatus, Status newStatus)
    {
        //Arrange
        ...
        vendaDTO.Status = newStatus;
        var result = _vendaService.PutVenda(numeroPedido, vendaDTO,lastStatus);
